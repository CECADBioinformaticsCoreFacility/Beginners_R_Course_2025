...
We understand that installing software can sometimes be challenging, especially 
for those who are new to programming. To ensure that everyone is well-prepared 
and can fully engage in the course, we will be hosting a pre-course Zoom session.
This session is intended to help with the installation process, address any 
issues you might encounter, and answer any questions. Stay tuned for the 
schedule and details. It is practically not possible to cater any technical 
issues during the Course itself. So, we urge you to please take part in the 
pre-course session.
:::
